...
import com.github.mohrezal.identity.domain.privilege.command.UpdatePermissionCommand;
...
public class PermissionController {
    ...
    @RequiresPermission(Permissions.IDENTITY_PRIVILEGE_PERMISSIONS_UPDATE)
