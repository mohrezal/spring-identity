...
public class AuditMessageConsumer {
    ...
    public void consume(AuditEvent event) {
        var entity = AuditEventEntity.builder()
                ...
                .forwardedHost(event.request() != null ? event.request().forwardedHost() : null)
                .forwardedProto(event.request() != null ? event.request().forwardedProto() : null)
                .reason(event.reason())
                .build();
